...
For a deeper guide see [`docs/build-a-domain.md`](https://github.com/kiff-framework/kiff-framework/blob/main/docs/build-a-domain.md) and [`docs/conventions.md`](https://github.com/kiff-framework/kiff-framework/blob/main/docs/conventions.md) in the framework repository.
